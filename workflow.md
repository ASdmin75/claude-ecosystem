...
### 2026-03-27 — Логотип и брендинг Web UI

- Создан логотип проекта: фиолетовый гексагон (оркестратор) с янтарными/фиолетовыми узлами-агентами
- Favicon (32x32 `.ico` + 192x192 `.png` для мобильных) — `web/public/favicon.ico`, `logo-192.png`
- Логотип в sidebar навигации (`App.tsx`) — иконка над заголовком "Claude Ecosystem"
- Логотип на странице логина (`Login.tsx`) — над формой авторизации
- Прозрачный фон для корректного отображения на тёмной теме
- Исходник: `docs/logo/cd6c1191-9469-40c3-b337-447c328d0a03.png`

**Файлы:**
- `web/public/` — `logo.png`, `logo-cropped.png`, `favicon.ico`, `logo-192.png`, `logo-512.png`
- `web/index.html` — подключение favicon и apple-touch-icon
- `web/src/App.tsx` — логотип в sidebar
- `web/src/components/Login.tsx` — логотип на странице логина
...
- [x] Логотип проекта: favicon, sidebar, страница логина (2026-03-27)
