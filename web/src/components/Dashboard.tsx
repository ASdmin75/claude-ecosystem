...
export default function Dashboard() {
  ...
  const stats = [
    ...
    { label: 'Completed', value: data.completed, color: 'text-green-600 dark:text-green-400' },
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-3 gap-4">
        {stats.map((s) => (
          <div key={s.label} className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow dark:shadow-gray-950">
